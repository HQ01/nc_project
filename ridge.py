...
Code credit to Aria Wang et.al. source: https://github.com/ariaaay/NeuralTaskonomy, which is a modification of code from 
the following source: https://github.com/jayanthkoushik/torch-gel
"""
